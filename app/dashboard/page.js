                ...
                <td className="py-2 px-4">
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="p-2 text-blue-600 hover:text-white hover:bg-blue-600 rounded-full transition-all duration-200 ease-in-out transform hover:scale-105"
                      title="Edit User"
                    >
                    ...
                    <button
                      ...
                      className="p-2 text-red-600 hover:text-white hover:bg-red-600 rounded-full transition-all duration-200 ease-in-out transform hover:scale-105"
                      title="Delete User"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
